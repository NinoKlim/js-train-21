...
class Musician {
  ...
  play() {
    ...
    console.log(`${this.#name} play on ${this.#instrument}`);
  }
}
...
class Guitarist extends Musician {
  ...
  play() {
    console.log(
      `${super.name} play on ${super.instrument} in the group ${this.#band}`
    );
  }
}
...
class Bassist extends Musician {
  ...
  play() {
    console.log(
      `${super.name} play on ${super.instrument} in the ${this.#band}`
    );
  }
}
...
class Concert extends Performance {
  ...
  info() {
    console.log(
      `Group ${super.band.name} will play in ${super.location} ${
        super.date
...
class Vocalist {
  ...
  info() {
    console.log(`Vokalist ${this.#name} is a member of ${this.#band}`);
  }
}
...
class SongWriter {
  ...
  info() {
    console.log(`Wrote ${this.songs.length} songs`);
  }
}
